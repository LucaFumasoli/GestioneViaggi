<script>
	...
	function addStop() {
		...
		if (nome != null && orario != null && prezzo != null) {
			document.getElementById('fermate').innerHTML += '<div class="row" style="color: white;"><div class="col-2"></div><div class="col-2"><span>num</span><input type="number" value="' + nFer + '" class="form-control" /></div><div class="col-2"><span>nome</span><input type="text" value="' + nome + '" class="form-control" id="nome' + nFer + '" /></div><div class="col-2"><span>orario</span><input type="datetime-local" value="' + orario + '" class="form-control" id="orario' + nFer + '" /></div><div class="col-2"><span>prezzo</span><input type="prezzo" value="' + prezzo + '" class="form-control" id="prezzo' + nFer + '" /></div></div><br>';
