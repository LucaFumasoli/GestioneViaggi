...
<form action="<?php echo URL . 'home/users' ?>" method="POST">
	...
	<div class="row" style="color: white;">
		...
		for($i = 0; $i < count($arrUsers); $i++){?>
			<a href="<?php echo URL . 'home/userInfo/'?><?php echo $arrUsers[$i]["id"] . '/'?><?php echo $arrUsers[$i]["nome"] . '/'?><?php echo $arrUsers[$i]["cognome"] . '/'?><?php echo $arrUsers[$i]["email"] . '/'?>" style="text-decoration: none;">
			<div class="row" style="color: white;">
